...
BroadcastRepNum::BroadcastRepNum(quint16 value):
  TLV(constants::TLVtags::BROADCAST_REP_NUM, 2),
  value(value) {
...
bool BroadcastRepNum::operator ==(
  const BroadcastRepNum &other) const {
...
BroadcastRepNum &BroadcastRepNum::operator =(
  const BroadcastRepNum &other) {
  if(*this == other)
    return *this;
  TLV::operator =(other);
  value = other.getValue();
